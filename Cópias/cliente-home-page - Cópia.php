<!--A Design by W3layouts
   ...
   -->
<?php
    include("controllers/variaveis.php");
    include("class/conexao.php");
    include("class/crud.php");
    include("controllers/interceptavisitante.php");
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
               ...
               <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     ...
                     <li class="nav-item">
                        <a href="#contact" class="nav-link scroll">Wilmo Morande Deodato <span class="online-ico">֍</span></a>
                     </li>
                  </ul>
               </div>
            </nav>
      ...
      <section class="gallery py-lg-4 py-md-3 py-sm-3 py-3 " id="gallery">
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
          ...
          <div class="reserva-ico">
              ...
              ?>
                  <span><?php echo $Fetch['id_reserva']; ?></span>
                  <span><?php echo $Fetch['id_cliente']; ?></span>
                  <span><?php echo $Fetch['id_quarto']; ?></span>
                  <span><?php echo $Fetch['data_res']; ?></span>
                  <span><?php echo $Fetch['estado_res']; ?></span>
                  <span><?php echo $Fetch['estado']; ?></span>
              <?php } ?>
          </div>
      </section>
      <!--//Gallery-->
